---
title: "Lecture 10 In Class Framework"
format: 
  html:
    self-contained: true
---
...
```{sql connection=con}
SELECT * FROM pmc.all_patient_records target
WHERE 
