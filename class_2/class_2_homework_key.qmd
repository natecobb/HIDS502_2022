...
SELECT COUNT(DISTINCT patient)
FROM encounters 
  -- We looked this up previously, its the code for 'NO_INSURANCE'
...
SELECT EXTRACT(YEAR from encounters.start) AS encounter_year, COUNT(DISTINCT encounters.patient) as patients
  ...
  LEFT JOIN payer_transitions ON
    ...
    AND encounters.start BETWEEN start_year and end_year
WHERE payer_transitions.payer <> 'b1c428d6-4f07-31e0-90f0-68ffa6ff8c76' -- The had some sort of insurance at the time
AND encounters.payer = 'b1c428d6-4f07-31e0-90f0-68ffa6ff8c76' -- But the encounter was billed to 'NO_INSURANCE'
